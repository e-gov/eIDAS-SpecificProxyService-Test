...
class Steps {
    ...
    public static String getAuthnRequest(Flow flow, String providerName, String loa = LOA_HIGH, AuthnContextComparisonTypeEnumeration comparison = AuthnContextComparisonTypeEnumeration.MINIMUM, String nameIdFormat = NameIDType.UNSPECIFIED, String spType = "public") {
    ...
    public static String getAuthnRequestWithOptionalAttributes(Flow flow, String providerName, String loa = LOA_HIGH, AuthnContextComparisonTypeEnumeration comparison = AuthnContextComparisonTypeEnumeration.MINIMUM, String nameIdFormat = NameIDType.UNSPECIFIED, String spType = "public") {
    ...
    public static Response startAuthProcessFollowRedirectsToTara(Flow flow, String samlRequest) {
    ...
    public static Response authenticateWithMidAndFollowRedirects(Flow flow, Response taraLoginPageResponse) {
    ...
    public static Response userConsentAndFollowRedirects(Flow flow, Response response) {
    ...
    public static Response userDenyConsentAndFollowRedirects(Flow flow, Response response) {
        //TODO: if consent is disabled
        //String consentAction = response4.body().htmlPath().get("**.find {it.@id == 'consentSelector'}.@action")
        String consentToken = response.body().htmlPath().get("**.find {it.@id == 'consentSelector'}.input[0].@value")
    ...
    public static Response userCancelAndFollowRedirects(Flow flow, Response response) {
    ...
    public static Response followRedirect(Flow flow, Response response) {
